...
#ifdef _WIN64
#pragma comment(lib, "../x64/Debug/OS15_HTAPI.lib")
#else
#pragma comment(lib, "../Debug/OS15_HTAPI.lib")
#endif

#pragma region Реализация_IUnknown_для_компонента
...
#pragma region Реализация_IHT

STDMETHODIMP ComponentHT::create(ht::HtHandle** htHandle, int capacity, int secSnapshotInterval, int maxKeyLength, int maxPayloadLength, const wchar_t* htUsersGroup, const wchar_t* fileName)
{
...
STDMETHODIMP ComponentHT::openAuth(ht::HtHandle** htHandle, const wchar_t* fileName, const wchar_t* htUser, const wchar_t* htPassword, bool isMapFile)
{
...
#pragma region Реализация_IElement
